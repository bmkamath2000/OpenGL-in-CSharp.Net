...
/*
	...
	DrawTextXY(-2.5,-0.2,0.0,0.001,"     AMBIKA ");
	DrawTextXY(1,-0.2,0.0,0.001,"        NEETHI ALVA ");
	glColor3f(0.7,0.8,0.6);
	DrawTextXY(-2.5,-0.45,0.0,0.001,"     (1CE08CS006) ");
	DrawTextXY(1,-0.45,0.0,0.001,"     (1CE08CS055) ");
*/
	glFlush();			//Finish rendering
	glutSwapBuffers();
...
*/
	...
	glColor3f(1.0,0.5,0.0);
	DrawTextXY(-2.5,1.2,0.0,0.001,"     AMBIKA ");
	DrawTextXY(1,1.2,0.0,0.001,"        NEETHI ALVA ");
	glColor3f(0.7,0.8,0.6);
	DrawTextXY(-2.5,0.95,0.0,0.001,"     (1CE08CS006) ");
	DrawTextXY(1,0.95,0.0,0.001,"        (1CE08CS055) ");
